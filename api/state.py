...
def get_app_state(
    ...
    """Loads the most recent cache file for ``season`` (or the newest across every season found,
    if omitted) on first access — the process-wide state every endpoint reads from."""
    global _app_state
